...
function renderChart() {
  ...
  switch (chartType) {
    case 0:
      ...
      break;
    case 1:
      query['stages.current.id'] = 2;
      query['stages.current.outcome.id'] = 1;
      howDoYouKnowUs(query);
      break;
    case 2:
      query['stages.current.id'] = 2;
      query['stages.current.outcome.id'] = 3;
      howDoYouKnowUs(query);
      break;
    case 3:
      ages(query);
    ...
    case 8:
      ...
      break;
    case 9:
      query['stages.current.id'] = 3;
      regions(query);
      break;
    case 10:
      query['stages.current.id'] = 4;
      regions(query);
      break;
  }
}
